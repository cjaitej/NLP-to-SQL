...
"""
    ...
    sub_path = os.path.join("spider", "dev_subset.json") if data_set=="spider" else sub_path=os.path.join("data","bird","dev_subset.json")
    ...
    for i, item in enumerate(data_to_evaluate):
        ...
        path = os.path.join("spider", "database", db_id, f"{db_id}.sqlite") if data_set=="spider" else path = os.path.join("data","bird","dev_databases", db_id, f"{db_id}.sqlite")
